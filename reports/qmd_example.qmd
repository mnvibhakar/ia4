...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){width=75% #fig-horsepops}


We can see from @fig-horsepops that Ontario, Saskatchewan and Alberta 
...
Additionally, note that in @tbl-stddev we consider the sample standard deviation of the number of horses during the same time span as @fig-largestd.

![Horse Populations for the province with the largest standard deviation](../results/horse_pop_plot_largest_sd.png){width=65% #fig-largestd}



In @fig-largestd we zoom in and look at the province of `{r} largest_sd`, which had the largest spread of values in terms of standard deviation.
